...
function normalizeArtifactInspectorStatusSummary(value) {
  ...
  return {
    ...
    auditNextActionText: normalizeCompareSessionField(row.auditNextActionText, 320) || "audit_next_action: none | trigger=idle",
    auditOperatorSummaryText: normalizeCompareSessionField(row.auditOperatorSummaryText, 320) || "audit_operator_summary: idle -> none | because=no_history",
...
function buildArtifactInspectorAuditControlState(recentActionsText, auditStateText) {
...
export function App() {
  ...
  const artifactInspectorDecisionMaintenanceLastClearText = React.useMemo(
    () => buildArtifactInspectorDecisionLine(
      artifactInspectorStatusSummary.maintenanceLastClearText,
      "maintenance_last_clear",
      "artifact_inspector_maintenance_last_clear"
    ),
    [artifactInspectorStatusSummary.maintenanceLastClearText]
  );
  const artifactInspectorDecisionMaintenanceSummaryText = React.useMemo(
    () => buildArtifactInspectorDecisionLine(
  ...
  const artifactInspectorDecisionAuditCapacityText = React.useMemo(
    () => buildArtifactInspectorDecisionLine(
      artifactInspectorStatusSummary.auditCapacityText,
      "audit_capacity",
      "artifact_inspector_audit_capacity"
    ),
    [artifactInspectorStatusSummary.auditCapacityText]
  );
  const artifactInspectorDecisionAuditWindowText = React.useMemo(
    () => buildArtifactInspectorDecisionLine(
  ...
  const artifactInspectorDecisionAuditHealthText = React.useMemo(
    () => buildArtifactInspectorDecisionLine(
  ...
  const artifactInspectorDecisionAuditNextActionText = React.useMemo(
    () => buildArtifactInspectorDecisionLine(
      artifactInspectorStatusSummary.auditNextActionText,
      "audit_next_action",
      "artifact_inspector_audit_next_action"
    ),
    [artifactInspectorStatusSummary.auditNextActionText]
  );
  const artifactInspectorDecisionAuditOperatorSummaryText = React.useMemo(
    () => buildArtifactInspectorDecisionLine(
      artifactInspectorStatusSummary.auditOperatorSummaryText,
      "audit_operator_summary",
  ...
  const artifactInspectorDecisionAuditControlState = React.useMemo(
    () => buildArtifactInspectorAuditControlState(
      artifactInspectorStatusSummary.recentActionsText,
      artifactInspectorStatusSummary.auditStateText
    ),
    ...
    issueArtifactInspectorControlRequest(
      {
        ...
        maintenanceClearSource: "decision_pane",
