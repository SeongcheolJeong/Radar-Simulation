  ...
  return h("div", { className: "field", key: "decision_surface" }, [
    ...
    h("div", { className: "field", key: "decision_artifact_state_mirror" }, [
      ...
      h("div", { className: "btn-row", key: "decision_artifact_state_mirror_actions" }, [
        ...
        h("button", {
          className: "btn",
          key: "decision_clear_artifact_inspector_maintenance_last_clear",
          onClick: clearArtifactInspectorMaintenanceLastClearFromDecisionPane,
          disabled: artifactInspectorDecisionMaintenanceLastClearControlState?.clearDisabled === true,
      ...
      h("div", { className: "hint", key: "decision_artifact_inspector_live_state_maintenance_last_clear_summary_hint" }, String(artifactInspectorDecisionMaintenanceLastClearSummaryText || "-")),
      h("div", { className: "hint", key: "decision_artifact_inspector_live_state_maintenance_last_clear_at_utc_hint" }, String(artifactInspectorDecisionMaintenanceLastClearAtUtcText || "-")),
      h("div", { className: "hint", key: "decision_artifact_inspector_live_state_maintenance_last_clear_operator_summary_hint" }, String(artifactInspectorDecisionMaintenanceLastClearOperatorSummaryText || "-")),
      h("div", { className: "hint", key: "decision_artifact_inspector_live_state_maintenance_last_clear_controls_hint" }, String(artifactInspectorDecisionMaintenanceLastClearControlState?.text || "artifact_inspector_maintenance_last_clear_controls: -")),
