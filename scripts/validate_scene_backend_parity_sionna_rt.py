...
def run() -> None:
    with tempfile.TemporaryDirectory(prefix="validate_sionna_parity_") as td:
        ...
        out_json = root / "scene_backend_parity_sionna_rt.json"
        ...
        assert "run_scene_backend_parity_sionna_rt: done" in proc.stdout, proc.stdout

        payload = json.loads(out_json.read_text(encoding="utf-8"))
        assert payload["report_name"] == "scene_backend_parity_sionna_rt"
