...
URL="http://localhost:${UI_PORT}/frontend/avx_like_dashboard.html?summary=/${SUMMARY_REL}&api=http://127.0.0.1:${API_PORT}&scene=${SCENE_REL}&profile=fast_debug&baseline_id=main_baseline&regression_session_id=main_regression&regression_export_id=main_regression_export"
