...
def run() -> None:
  ...
  required_tokens = [
    ...
    "controls-trail guard controls controls continuity echo: ",
  ...
  assert not missing, (
    ...
    "timeline-import-audit-controls-trail-guard-controls-controls-controls-trail-refresh tokens: "
    f"{missing}"
  )

  print("validate_quick_telemetry_strict_rollback_package_trust_audit_bundle_apply_dry_run_handoff_package_apply_safety_activity_replay_timeline_import_audit_controls_trail_guard_controls_controls_controls_trail_refresh: pass")
