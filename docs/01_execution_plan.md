...
- [ ] M17.112: Quick telemetry strict-cutover rollback trust audit bundle apply dry-run handoff package apply safety activity replay timeline import audit controls-trail guard controls controls apply refresh (continuity-echo guard-controls-controls guidance parity in apply continuity states)
...
Advance post-M17.111 frontend hardening track: add strict-cutover rollback trust audit bundle apply dry-run handoff package apply safety activity replay timeline import audit controls-trail guard controls controls apply refresh (continuity-echo guard-controls-controls guidance parity in apply continuity states) while keeping M16.5+M17.0 semantics (cache/cancel/retry/async polling) stable.
