...
- [ ] M17.114: Quick telemetry strict-cutover rollback trust audit bundle apply dry-run handoff package apply safety activity replay timeline import audit controls-trail guard controls controls controls refresh (continuity-echo guard-controls-controls guidance parity in controls status lifecycle)
...
Advance post-M17.113 frontend hardening track: add strict-cutover rollback trust audit bundle apply dry-run handoff package apply safety activity replay timeline import audit controls-trail guard controls controls controls refresh (continuity-echo guard-controls-controls guidance parity in controls status lifecycle) while keeping M16.5+M17.0 semantics (cache/cancel/retry/async polling) stable.
