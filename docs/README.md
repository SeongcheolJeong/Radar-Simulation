...
- [역할별 Frontend Evidence 읽기 순서](335_frontend_evidence_read_order_by_role_ko.md)
  ...
  - [Classic Dashboard 결과/증거 빠른 읽기 가이드](315_classic_dashboard_result_evidence_quick_guide_ko.md)
  ...
  - [Classic Dashboard 상태 필드 가이드](319_classic_dashboard_status_field_guide_ko.md)
