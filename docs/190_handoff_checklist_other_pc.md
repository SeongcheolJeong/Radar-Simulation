...
- `/home/seongcheoljeong/workspace/myproject/docs/reports/po_sbr_physical_full_track_function_test_2026_03_01_3605f4b.json` (`overall_status=ready`, one-command fresh full-track function test)
