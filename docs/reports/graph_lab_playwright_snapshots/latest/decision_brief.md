...
- generated_at_utc: 2026-03-07T12:01:39.783Z
- graph_id: radar_minimal_v1

## Decision Snapshot
```text
generated_at_utc: 2026-03-07T12:01:39.446Z
decision: ADOPT
recommendation: adopt_candidate
baseline_id: playwright_baseline
current_run_id: grun_20260307_120137_9fdef1c9
compare_run_id: grun_20260307_120137_9fdef1c9
...
latest_compare_session: 2026-03-07T12:01:38.848Z | source=pin_current | status=pinned | pair=low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | compare=grun_20260307_120137_9fdef1c9
...
- compare_status: compare_mode=pinned_current | run=grun_20260307_120137_9fdef1c9 | waiting_for_next_run=true
- latest_replayable_pair: low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | pinned=false
- selected_history_pair: Low Fidelity Saved
- selected_history_pair_meta: pinned=true | custom_label=Low Fidelity Saved
- selected_history_artifact_expectation: source=observed_ready_pair | assessment=review | required=4/4/4 | artifact_delta=none | path_hashes=5
...
- [1] Low Fidelity Saved | baseline=low_fidelity_radarsimpy_ffd | target=current_config
  ...
  artifact_path_hashes: path_hashes=5 | path_list_json:90434a42/9f0b16ac | adc_cube_npz:1bb89766/92adfb00
```

## Compare Session History
```text
[1] 2026-03-07T12:01:38.848Z | source=pin_current | status=pinned | pair=low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | compare=grun_20260307_120137_9fdef1c9
[2] 2026-03-07T12:01:37.165Z | source=preset_pair | status=ready | pair=Low Fidelity Saved | pin=yes | phase=current | compare=grun_20260307_120136_51cabebb | current=grun_20260307_120136_1d7b5f95 | assessment=review
[3] 2026-03-07T12:01:35.649Z | source=pin_current | status=pinned | pair=Low Fidelity Saved | pin=yes | compare=grun_20260307_120134_2f7d6fbe
```
...
observed_at_utc: 2026-03-07T12:01:37.165Z
...
- path_list_json: current=path_list.json#90434a42 compare=path_list.json#9f0b16ac
- adc_cube_npz: current=adc_cube.npz#1bb89766 compare=adc_cube.npz#92adfb00
- radar_map_npz: current=radar_map.npz#885597a5 compare=radar_map.npz#d8393edf
- graph_run_summary_json: current=graph_run_summary.json#d8e9bdcb compare=graph_run_summary.json#383953f9
- lgit_customized_output_npz: current=lgit_customized_output.npz#75e25384 compare=lgit_customized_output.npz#a276e826
artifact_rows:
...
## Current Artifacts
- graph_run_summary_json: /tmp/graph_lab_playwright_e2e__kx9ytp5/store/graph_runs/grun_20260307_120137_9fdef1c9/graph_run_summary.json
- radar_map_npz: /tmp/graph_lab_playwright_e2e__kx9ytp5/store/graph_runs/grun_20260307_120137_9fdef1c9/output/radar_map.npz
- adc_cube_npz: /tmp/graph_lab_playwright_e2e__kx9ytp5/store/graph_runs/grun_20260307_120137_9fdef1c9/output/adc_cube.npz
- path_list_json: /tmp/graph_lab_playwright_e2e__kx9ytp5/store/graph_runs/grun_20260307_120137_9fdef1c9/output/path_list.json
...
## Regression Session
- session_id: dssn_1772884899518
- session_recommendation: adopt_all_candidates
- export_id: rexp_20260307_120139_88d13ef7
- export_package_json: /tmp/graph_lab_playwright_e2e__kx9ytp5/store/regression_exports/rexp_20260307_120139_88d13ef7/regression_package.json