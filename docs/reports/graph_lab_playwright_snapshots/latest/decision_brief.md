...
- generated_at_utc: 2026-03-07T12:16:51.162Z
- graph_id: radar_minimal_v1

## Decision Snapshot
```text
generated_at_utc: 2026-03-07T12:16:50.906Z
decision: ADOPT
recommendation: adopt_candidate
baseline_id: playwright_baseline
current_run_id: grun_20260307_121649_36a8b821
compare_run_id: grun_20260307_121649_36a8b821
...
latest_compare_session: 2026-03-07T12:16:50.195Z | source=pin_current | status=pinned | pair=low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | compare=grun_20260307_121648_a923dfde
...
- current_track: backend=radarsimpy_rt | sim=radarsimpy.sim_radar | mux=tdm | ant=isotropic | license=set
- compare_track: backend=radarsimpy_rt | sim=radarsimpy.sim_radar | mux=tdm | ant=isotropic | license=set
- compare_runner_status: track_compare_runner: mode=preset_pair | baseline_ready=grun_20260307_121649_36a8b821 | baseline_preset=low_fidelity_radarsimpy_ffd | target_preset=current_config | phase=current
- compare_status: compare_mode=runner_preset_pair | baseline_preset=low_fidelity_radarsimpy_ffd | run=grun_20260307_121649_36a8b821 | status=completed
- latest_replayable_pair: low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | pinned=false
- selected_history_pair: Low Fidelity Saved
- selected_history_pair_meta: pinned=true | custom_label=Low Fidelity Saved
- selected_history_artifact_expectation: source=observed_ready_pair | assessment=review | required=4/4/4 | artifact_delta=none | path_hashes=5
...
- [1] Low Fidelity Saved | baseline=low_fidelity_radarsimpy_ffd | target=current_config
  ...
  artifact_path_hashes: path_hashes=5 | path_list_json:97d7dd8f/f2fd7408 | adc_cube_npz:ee2650bf/086a6004
```

## Compare Session History
```text
[1] 2026-03-07T12:16:50.195Z | source=pin_current | status=pinned | pair=low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | compare=grun_20260307_121648_a923dfde
[2] 2026-03-07T12:16:47.786Z | source=preset_pair | status=ready | pair=Low Fidelity Saved | pin=yes | phase=current | compare=grun_20260307_121646_e6d18a6f | current=grun_20260307_121647_fc2c6045 | assessment=review
[3] 2026-03-07T12:16:46.212Z | source=pin_current | status=pinned | pair=Low Fidelity Saved | pin=yes | compare=grun_20260307_121644_1be47e25
```
...
observed_at_utc: 2026-03-07T12:16:47.785Z
...
- path_list_json: current=path_list.json#97d7dd8f compare=path_list.json#f2fd7408
- adc_cube_npz: current=adc_cube.npz#ee2650bf compare=adc_cube.npz#086a6004
- radar_map_npz: current=radar_map.npz#4f5651da compare=radar_map.npz#5ddd9be3
- graph_run_summary_json: current=graph_run_summary.json#ad2e0290 compare=graph_run_summary.json#c342bf9d
- lgit_customized_output_npz: current=lgit_customized_output.npz#23f6dce9 compare=lgit_customized_output.npz#10d629ea
artifact_rows:
...
## Current Artifacts
- graph_run_summary_json: /tmp/graph_lab_playwright_e2e_2h_rqsk8/store/graph_runs/grun_20260307_121649_36a8b821/graph_run_summary.json
- radar_map_npz: /tmp/graph_lab_playwright_e2e_2h_rqsk8/store/graph_runs/grun_20260307_121649_36a8b821/output/radar_map.npz
- adc_cube_npz: /tmp/graph_lab_playwright_e2e_2h_rqsk8/store/graph_runs/grun_20260307_121649_36a8b821/output/adc_cube.npz
- path_list_json: /tmp/graph_lab_playwright_e2e_2h_rqsk8/store/graph_runs/grun_20260307_121649_36a8b821/output/path_list.json
...
## Regression Session
- session_id: dssn_1772885810973
- session_recommendation: adopt_all_candidates
- export_id: rexp_20260307_121651_472d3d20
- export_package_json: /tmp/graph_lab_playwright_e2e_2h_rqsk8/store/regression_exports/rexp_20260307_121651_472d3d20/regression_package.json