...
- generated_at_utc: 2026-03-07T12:09:51.768Z
- graph_id: radar_minimal_v1

## Decision Snapshot
```text
generated_at_utc: 2026-03-07T12:09:51.496Z
decision: ADOPT
recommendation: adopt_candidate
baseline_id: playwright_baseline
current_run_id: grun_20260307_120949_ad48b247
compare_run_id: grun_20260307_120949_ad48b247
...
latest_compare_session: 2026-03-07T12:09:50.961Z | source=pin_current | status=pinned | pair=low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | compare=grun_20260307_120949_8c88e74f
...
- current_track: backend=radarsimpy_rt | sim=radarsimpy.sim_radar | mux=tdm | ant=isotropic | license=set
- compare_track: backend=radarsimpy_rt | sim=radarsimpy.sim_radar | mux=tdm | ant=isotropic | license=set
- compare_runner_status: track_compare_runner: mode=preset_pair | baseline_ready=grun_20260307_120949_ad48b247 | baseline_preset=low_fidelity_radarsimpy_ffd | target_preset=current_config | phase=current
- compare_status: compare_mode=runner_preset_pair | baseline_preset=low_fidelity_radarsimpy_ffd | run=grun_20260307_120949_ad48b247 | status=completed
- latest_replayable_pair: low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | pinned=false
- selected_history_pair: Low Fidelity Saved
- selected_history_pair_meta: pinned=true | custom_label=Low Fidelity Saved
- selected_history_artifact_expectation: source=observed_ready_pair | assessment=review | required=4/4/4 | artifact_delta=none | path_hashes=5
...
- [1] Low Fidelity Saved | baseline=low_fidelity_radarsimpy_ffd | target=current_config
  ...
  artifact_path_hashes: path_hashes=5 | path_list_json:071a424b/bd400433 | adc_cube_npz:4eac9e63/8957f6eb
```

## Compare Session History
```text
[1] 2026-03-07T12:09:50.961Z | source=pin_current | status=pinned | pair=low_fidelity_radarsimpy_ffd -> high_fidelity_po_sbr_rt | compare=grun_20260307_120949_8c88e74f
[2] 2026-03-07T12:09:49.238Z | source=preset_pair | status=ready | pair=Low Fidelity Saved | pin=yes | phase=current | compare=grun_20260307_120948_37550912 | current=grun_20260307_120948_ce7be541 | assessment=review
[3] 2026-03-07T12:09:47.728Z | source=pin_current | status=pinned | pair=Low Fidelity Saved | pin=yes | compare=grun_20260307_120946_183d5298
```
...
observed_at_utc: 2026-03-07T12:09:49.238Z
...
- path_list_json: current=path_list.json#071a424b compare=path_list.json#bd400433
- adc_cube_npz: current=adc_cube.npz#4eac9e63 compare=adc_cube.npz#8957f6eb
- radar_map_npz: current=radar_map.npz#c64ede4e compare=radar_map.npz#a7263716
- graph_run_summary_json: current=graph_run_summary.json#54a2a564 compare=graph_run_summary.json#08793e4c
- lgit_customized_output_npz: current=lgit_customized_output.npz#55be95ad compare=lgit_customized_output.npz#29aba5d5
artifact_rows:
...
## Current Artifacts
- graph_run_summary_json: /tmp/graph_lab_playwright_e2e_99z63k3w/store/graph_runs/grun_20260307_120949_ad48b247/graph_run_summary.json
- radar_map_npz: /tmp/graph_lab_playwright_e2e_99z63k3w/store/graph_runs/grun_20260307_120949_ad48b247/output/radar_map.npz
- adc_cube_npz: /tmp/graph_lab_playwright_e2e_99z63k3w/store/graph_runs/grun_20260307_120949_ad48b247/output/adc_cube.npz
- path_list_json: /tmp/graph_lab_playwright_e2e_99z63k3w/store/graph_runs/grun_20260307_120949_ad48b247/output/path_list.json
...
## Regression Session
- session_id: dssn_1772885391572
- session_recommendation: adopt_all_candidates
- export_id: rexp_20260307_120951_08acfa6c
- export_package_json: /tmp/graph_lab_playwright_e2e_99z63k3w/store/regression_exports/rexp_20260307_120951_08acfa6c/regression_package.json