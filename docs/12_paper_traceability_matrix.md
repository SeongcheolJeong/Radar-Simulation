...
| R8 | Reflection/scattering path power modeling | Partial | `/Users/seongcheoljeong/Documents/Codex_test/src/avxsim/hybrid_pcode.py` (`calculate_reflecting_path_power`, `calculate_scattering_path_power`), `/Users/seongcheoljeong/Documents/Codex_test/src/avxsim/path_power_tuning.py` | `.../scripts/validate_hybrid_path_power_models.py`, `.../scripts/validate_path_power_tuning.py` | Physics-consistent replacement + tuning tooling implemented; real measured calibration CSV fitting is pending |
